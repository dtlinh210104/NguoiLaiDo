...
try:
    ...
    move_sound = pygame.mixer.Sound("move_sound.wav")  # Âm thanh di chuyển thuyền
except pygame.error as e:
...
def show_win_message():
    ...
    pygame.display.flip()
    win_sound.play()  # Phát âm thanh chiến thắng

    # Đợi 1.5 giây rồi reset trò chơi
...
def show_lose_message():
    ...
    screen.blit(text, text_rect)
    pygame.display.flip()
    lose_sound.play()  # Phát âm thanh thua
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_SPACE:
                ...
                if boat_position == "left":
                    ...
                    boat_position = "left"
                move_sound.play()  # Phát âm thanh khi di chuyển thuyền
